...
PIPELINE=http://localhost:8888/dos-static-2012-06-01
...
# old way gets Arg list too long error		perl -pi -e 's/http:\/\/heuristscholar.org\/dos-static-2012-06-01/../' item/*
grep -rl dos-static-2012-02-24 item |\
while read filename; do
	perl -pi -e 's/http:\/\/heuristscholar.org\/dos-static-2012-06-01/../' $filename;
done

# old way gets Arg list too long error		perl -pi -e 's/http:\/\/heuristscholar.org\/dos-static-2012-06-01/../' popup/*
grep -rl dos-static-2012-06-01 popup |\
while read filename; do
	perl -pi -e 's/http:\/\/heuristscholar.org\/dos-static-2012-06-01/../' $filename;
done
...
while read filename; do
	perl -pi -e 's/http:\/\/heuristscholar.org\/dos-static-2012-06-01/http:\/\/dictionaryofsydney.org/' $filename;
done
...
##########################################################################################
ln -s /var/www/dos-2012-06-01 test
...
#ln -fs /var/www/dos-2012-06-01 dos
