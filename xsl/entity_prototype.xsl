				...
				<tr>
					<xsl:element name="td">
						...
						<xsl:if test="detail/file_thumb_url">
							<a href="{$cocoonbase}{$browserbase}/{id}/{/export/references/reference/reftype/@id}?flavour={$flavour}"
								class="sb_two">
						...
						<a
							href="{$cocoonbase}{$browserbase}/{id}/{/export/references/reference/reftype/@id}?flavour={$flavour}"
							class="sb_two">
			...
			<td><!-- Source -->
				...
				<xsl:choose>
					...
					<xsl:when test="pointer[@id=528]/id and ../id != pointer[@id=528]/id">
						<a href="{$cocoonbase}{$browserbase}/{pointer[@id=528]/id}" class="sb_two">
			...
			<td><!-- Related -->
				<xsl:choose>
					<xsl:when test="pointer[@id=529]/id and ../id != pointer[@id=529]/id">
						<a href="{$cocoonbase}{$browserbase}/{pointer[@id=529]/id}" class="sb_two">
					...
					<xsl:when test="pointer[@id=528] and detail/@id=230">
						...
						<script>
							window.onload = function() {
								loadMap( { compact: true, highlight: [], onclick: function(record) { window.location = "/cocoon/dos/sandbox/item/"+record.bibID+"/"; } } );
							};
						</script>

					</xsl:when>
					<xsl:when test="pointer[@id=527]/id and ../id != pointer[@id=527]/id">
						<a href="{$cocoonbase}{$browserbase}/{pointer[@id=527]/id}" class="sb_two">
