...
echo "select rec_id from records where rec_type in (153,151,103,74,91,152,98);" | mysql -s -u readonly -pmitnick heuristdb-dos-sandbox | while read id; do wget -O item/$id http://heuristscholar.org/cocoon/relbrowser-kj/item/$id/; done
