...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
    ...
    <xsl:variable name="urlbase">/relbrowser-mq</xsl:variable>
    <xsl:variable name="cocoonbase">/cocoon/relbrowser-mq</xsl:variable>
    ...
    <xsl:variable name="site-title">Macquarie Plus</xsl:variable>
